# 🧠 Sentiment Analysis Using RNN Comparison

## 📄 Overview
This project compares multiple **Recurrent Neural Network (RNN)** architectures — including **Simple RNN, LSTM, and GRU** — for sentiment analysis on textual data.  
